...
export function Sidebar({ isOpen }: { isOpen: boolean }) {
  ...
  return (
    <aside
      className={cn(
        "p-4 border-r border-slate-800 flex flex-col transition-all duration-300 ease-in-out",
        isOpen ? "w-[300px]" : "w-0 p-0 opacity-0"
      )}
    >
      <div
        className={cn(
                  ...
                  {editingChatId !== chat.id && (
                    <>
                      <Button
                        ...
                        className="h-6 w-6"
                        onClick={() =>
                          handleRename(chat.id, getChatTitle(chat))
                        }
                      >
                        ...
                        <AlertDialogContent className="bg-slate-900 text-slate-50 border-slate-700">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              permanently delete the chat titled: <br />
                          ...
                          <AlertDialogFooter>
                            <AlertDialogCancel className="transition-colors hover:bg-slate-800">
                              Cancel
                            </AlertDialogCancel>
                            <AlertDialogAction
